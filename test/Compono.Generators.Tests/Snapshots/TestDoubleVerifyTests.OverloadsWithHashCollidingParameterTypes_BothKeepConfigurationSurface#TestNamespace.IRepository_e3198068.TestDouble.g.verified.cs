...
internal static class TestNamespace_IRepository_e3198068_ClearCallsExtension
{
    public static void ClearCalls(this global::TestNamespace.IRepository self)
    {
        ...
        lock (__double.__Handle_3b7828aa_lock) { __double.__Handle_3b7828aa_calls.Clear(); }
        lock (__double.__Handle_b5b0a4ae_lock) { __double.__Handle_b5b0a4ae_calls.Clear(); }
    }
}

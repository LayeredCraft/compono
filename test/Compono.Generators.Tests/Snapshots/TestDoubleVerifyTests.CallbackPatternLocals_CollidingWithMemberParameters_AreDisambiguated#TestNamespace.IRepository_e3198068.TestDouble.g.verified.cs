...
{
    internal delegate int __Add_Callback(int callback, int configuredCallback);

    internal readonly ref struct __Add_Builder
    {
        private readonly ref global::Compono.ReturnConfig<int> _config;
        private readonly ref __Add_Callback? _callback;

        internal __Add_Builder(ref global::Compono.ReturnConfig<int> config, ref __Add_Callback? callback)
        {
            _config = ref config;
        ...
        public void ReturnsCallback(__Add_Callback callback)
        {
    ...
    // __Add/__Add_m_{param} shape with an ordered, append-only
    // entry list. Configure() appends; dispatch scans in reverse (last-matching-registration-wins).
    internal sealed class __Add_Entry
    {
        internal global::Compono.Match<int>? Matcher_callback;
        internal global::Compono.Match<int>? Matcher_configuredCallback;
        internal global::Compono.ReturnConfig<int> Config;
        internal __Add_Callback? Callback;
    }

    internal readonly global::System.Collections.Generic.List<__Add_Entry> __Add_entries = [];
    internal readonly global::System.Collections.Generic.List<(int, int)> __Add_calls = [];
    internal readonly object __Add_lock = new();
    ...
    // internal __Add_calls tuple above uses for its own, unrelated, internal-only
    ...
    internal readonly record struct __Add_ReceivedCall(int callback, int configuredCallback);

    int global::TestNamespace.IRepository.Add(int callback, int configuredCallback)
    {
        __Add_Callback? __callback = null;
        ...
        lock (__Add_lock)
        {
            __Add_calls.Add((callback, configuredCallback));
            for (var __i = __Add_entries.Count - 1; __i >= 0; __i--)
            {
                var __entry = __Add_entries[__i];
                if ((__entry.Matcher_callback is not { } __m_callback || __m_callback.Matches(callback)) && (__entry.Matcher_configuredCallback is not { } __m_configuredCallback || __m_configuredCallback.Matches(configuredCallback)))
                {
                    if (__entry.Callback is { } _configuredCallback)
                    {
                        __callback = _configuredCallback;
                        break;
                    }
        ...
        if (__callback is { } _callback)
            return _callback(callback, configuredCallback);
        return default;
    }
}
...
{
    public static global::TestNamespace_IRepository_e3198068_Double.__Add_Builder Add(this global::TestNamespace_IRepository_e3198068_Double __self, global::Compono.Match<int> callback, global::Compono.Match<int> configuredCallback)
    {
        ...
        // round 5).
        var __entry = new global::TestNamespace_IRepository_e3198068_Double.__Add_Entry();
        __entry.Matcher_callback = callback;
        __entry.Matcher_configuredCallback = configuredCallback;
        lock (__self.__Add_lock) { __self.__Add_entries.Add(__entry); }
        return new global::TestNamespace_IRepository_e3198068_Double.__Add_Builder(ref __entry.Config, ref __entry.Callback);
    }
    ...
    public static global::TestNamespace_IRepository_e3198068_Double.__Add_Builder Add(this global::TestNamespace_IRepository_e3198068_Double self)
    {
        var __entry = new global::TestNamespace_IRepository_e3198068_Double.__Add_Entry();
        lock (self.__Add_lock) { self.__Add_entries.Add(__entry); }
        return new global::TestNamespace_IRepository_e3198068_Double.__Add_Builder(ref __entry.Config, ref __entry.Callback);
    }
...
{
    public static global::Compono.CallVerifier Add(this global::TestNamespace_IRepository_e3198068_DoubleVerifier __self, global::Compono.Match<int> callback, global::Compono.Match<int> configuredCallback)
    {
        int __count;
        lock (__self.Instance.__Add_lock)
        {
            __count = 0;
            foreach (var call in __self.Instance.__Add_calls)
            {
                if (callback.Matches(call.Item1) && configuredCallback.Matches(call.Item2))
                    __count++;
            }
        }
        return new(__count, "global::TestNamespace.IRepository.Add");
    }
    ...
    public static global::Compono.CallVerifier Add(this global::TestNamespace_IRepository_e3198068_DoubleVerifier self)
    {
        int __count;
        lock (self.Instance.__Add_lock) { __count = self.Instance.__Add_calls.Count; }
        return new(__count, "global::TestNamespace.IRepository.Add");
    }
...
internal static class TestNamespace_IRepository_e3198068_DoubleReceivedCallsAccess
{
    ...
    public static global::System.Collections.Generic.IReadOnlyList<global::TestNamespace_IRepository_e3198068_Double.__Add_ReceivedCall> Add(this global::TestNamespace_IRepository_e3198068_DoubleReceivedCalls self)
    {
        lock (self.Instance.__Add_lock)
        {
            var __snapshot = new global::TestNamespace_IRepository_e3198068_Double.__Add_ReceivedCall[self.Instance.__Add_calls.Count];
            for (var __i = 0; __i < __snapshot.Length; __i++)
            {
                var call = self.Instance.__Add_calls[__i];
                __snapshot[__i] = new(call.Item1, call.Item2);
            }
...
internal static class TestNamespace_IRepository_e3198068_ClearCallsExtension
{
    public static void ClearCalls(this global::TestNamespace.IRepository self)
    {
        ...
        lock (__double.__Add_lock) { __double.__Add_calls.Clear(); }
    }
}

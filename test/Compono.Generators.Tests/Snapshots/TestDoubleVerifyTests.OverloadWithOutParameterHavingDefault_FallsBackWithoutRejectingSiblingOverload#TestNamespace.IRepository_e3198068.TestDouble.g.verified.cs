...
internal sealed class TestNamespace_IRepository_e3198068_Double : global::TestNamespace.IRepository
{
    ...
    // internal __TryGet_calls tuple above uses for its own, unrelated, internal-only
    ...
    internal readonly record struct __TryGet_ReceivedCall(int id);
...
internal static class TestNamespace_IRepository_e3198068_DoubleReceivedCallsAccess
{
    ...
    public static global::System.Collections.Generic.IReadOnlyList<global::TestNamespace_IRepository_e3198068_Double.__TryGet_ReceivedCall> TryGet(this global::TestNamespace_IRepository_e3198068_DoubleReceivedCalls self)
    {
        lock (self.Instance.__TryGet_lock)
        {
            var __snapshot = new global::TestNamespace_IRepository_e3198068_Double.__TryGet_ReceivedCall[self.Instance.__TryGet_calls.Count];
            for (var __i = 0; __i < __snapshot.Length; __i++)
            {
                var call = self.Instance.__TryGet_calls[__i];
...
internal static class TestNamespace_IRepository_e3198068_ClearCallsExtension
{
    public static void ClearCalls(this global::TestNamespace.IRepository self)
    {
        ...
        lock (__double.__TryGet_lock) { __double.__TryGet_calls.Clear(); }
    }
}

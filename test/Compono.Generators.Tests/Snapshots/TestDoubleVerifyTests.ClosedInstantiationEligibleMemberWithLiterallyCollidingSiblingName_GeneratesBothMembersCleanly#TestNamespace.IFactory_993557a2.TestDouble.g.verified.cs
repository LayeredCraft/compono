...
internal sealed class TestNamespace_IFactory_993557a2_Double : global::TestNamespace.IFactory
{
    ...
    internal sealed class __Get_State<T> : TestNamespace_IFactory_993557a2_IClearableCallState where T : class
    {
        ...
        // Reached through the non-generic TestNamespace_IFactory_993557a2_IClearableCallState interface, since
...
#pragma warning restore CS8603, CS8616, CS8619
    ...
    string? global::TestNamespace.IFactory.Get_calls
    {
        get
        {
            ...
            return __Get_calls.HasConfiguredSequence ? __Get_calls.NextSequenceOutcome()
                : __Get_calls.HasConfiguredException ? throw __Get_calls.ConfiguredException
...
internal static class TestNamespace_IFactory_993557a2_ClearCallsExtension
{
    public static void ClearCalls(this global::TestNamespace.IFactory self)
    {
        ...
        __double.__Get_calls.ClearObservedCalls();
    }
}

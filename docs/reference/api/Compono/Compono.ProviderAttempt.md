...
design: `Compono.CompositionTraceBuffer` appends one of these per stage tried and rewinds on
...
at all \- `Compono.Providers.BuiltInProviders.Default` already registers three

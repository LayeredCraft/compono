...
<a name='Compono.ReturnConfigBuilder_T_.Returns(T).value'></a>

`value` [T](Compono.ReturnConfigBuilder_T_.md#Compono.ReturnConfigBuilder_T_.T 'Compono\.ReturnConfigBuilder\<T\>\.T')
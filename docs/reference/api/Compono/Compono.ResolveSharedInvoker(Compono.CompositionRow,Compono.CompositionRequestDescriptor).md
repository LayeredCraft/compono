...
## ResolveSharedInvoker\(CompositionRow, CompositionRequestDescriptor\) Delegate
...
```csharp
public delegate object? ResolveSharedInvoker(Compono.CompositionRow row, in Compono.CompositionRequestDescriptor descriptor);
```
#### Parameters

<a name='Compono.ResolveSharedInvoker(Compono.CompositionRow,Compono.CompositionRequestDescriptor).row'></a>

`row` [CompositionRow](Compono.CompositionRow.md 'Compono\.CompositionRow')

<a name='Compono.ResolveSharedInvoker(Compono.CompositionRow,Compono.CompositionRequestDescriptor).descriptor'></a>

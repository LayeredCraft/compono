...
## CapturingLogger\<T\>\.BeginScope\<TState\>\(TState\) Method
...
<a name='Compono.Logging.CapturingLogger_T_.BeginScope_TState_(TState).TState'></a>
...
<a name='Compono.Logging.CapturingLogger_T_.BeginScope_TState_(TState).state'></a>

`state` [TState](Compono.Logging.CapturingLogger_T_.BeginScope_TState_(TState).md#Compono.Logging.CapturingLogger_T_.BeginScope_TState_(TState).TState 'Compono\.Logging\.CapturingLogger\<T\>\.BeginScope\<TState\>\(TState\)\.TState')

...
### [Compono](Compono.md 'Compono').[BogusMemberNameProvider](Compono.BogusMemberNameProvider.md 'Compono\.BogusMemberNameProvider')

## BogusMemberNameProvider\.TryProvide\(CompositionProviderRequest, ICompositionContext\) Method

Attempts to produce a value for [request](Compono.BogusMemberNameProvider.TryProvide(Compono.CompositionProviderRequest,Compono.ICompositionContext).md#Compono.BogusMemberNameProvider.TryProvide(Compono.CompositionProviderRequest,Compono.ICompositionContext).request 'Compono\.BogusMemberNameProvider\.TryProvide\(Compono\.CompositionProviderRequest, Compono\.ICompositionContext\)\.request')\. Returns
...
<a name='Compono.BogusMemberNameProvider.TryProvide(Compono.CompositionProviderRequest,Compono.ICompositionContext).request'></a>
...
<a name='Compono.BogusMemberNameProvider.TryProvide(Compono.CompositionProviderRequest,Compono.ICompositionContext).context'></a>

...
/// first <c>BuildFrom</c> call (<see cref="BindingPlan.Build"/>), never rebuilt or re-reflected on
/// the per-row path. Holds no row-scoped state: no <see cref="CompositionRow"/>, no composed value.
/// </summary>

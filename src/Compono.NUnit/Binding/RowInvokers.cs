...
/// path Native AOT-safe. Built against the existing, unchanged <see cref="Compono.RowInvokerRegistry"/>
/// from this package's first commit (ADR-0059) - no throwaway reflection-based version.
/// </summary>

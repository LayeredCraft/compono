...
/// <typeparamref name="TProfile"/> - matching <c>Compono.XunitV3</c>/<c>Compono.TUnit</c>/
/// <c>Compono.MSTest</c>'s own identical generic form exactly (same Compono-facing attribute family
/// and semantics).
/// </summary>
    ...
    where TProfile : ICompositionProfile, new()
{
    ...
    internal override void ApplyProfile(CompositionBuilder builder)
    {
        ...
        catch (CompositionException exception)
        {
            ...
            // Compono.NUnit-owned pre-composition failure uses, matching

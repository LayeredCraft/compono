...
/// name/qualifier-based sharing. See ADR-0059's binding sections for the full binding rules
/// (declaration order among <c>[Shared]</c> parameters, duplicate-type rejection, visibility
/// scoped to the current row - i.e. one <c>BuildFrom</c> call - only).
/// </remarks>

...
/// delegate invocation. See ADR-0022's "Runtime-typed CompositionRow invocation" section.
/// </summary>
...
/// path (Phase 2) never calls <c>MakeGenericMethod</c>/<c>MethodInfo.Invoke</c> at all.
/// </summary>
internal static class RowInvokers
{
    ...
    // Safe: Phase 2's inline-value validation (ADR-0022 step 5) always runs before this is ever
    // invoked, so `value` is already known to be null-or-assignable for this exact closed T.

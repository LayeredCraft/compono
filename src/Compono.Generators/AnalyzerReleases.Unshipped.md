...
CMP0040 | Compono.Usage | Error | A Compono.XunitV3.Aot-attributed test method has an unsupported signature (a generic test method, or a ref/out/in/params parameter) - unlike the other four [Compose]-family attribute integrations, this has no runtime BindingPlan.ValidateSignature-equivalent to fall back on, so it's caught here at compile time instead (ADR-0066/PLAN-0066)

...
/// <c>TConfig</c> - a package-local port of <c>Compono.XunitV3</c>'s own binder, matching ADR-0057's
...
/// <c>Lazy&lt;Composer&gt;</c>-backed caching, never the repeated per-row <c>GetData</c> path.
/// </remarks>
